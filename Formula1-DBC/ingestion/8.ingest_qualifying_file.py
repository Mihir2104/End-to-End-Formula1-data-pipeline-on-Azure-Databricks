...
# MAGIC %md
# MAGIC ##### Step 1 - Reading the JSON file using the spark dataframe reader API
...
#overwrite_partition(final_df1, 'f1_processed', 'qualifying', 'race_id')

# COMMAND ----------

merge_condition = "tgt.qualify_id = src.qualify_id AND tgt.race_id = src.race_id"
merge_delta_data(final_df1, 'f1_processed', 'qualifying', processed_folder_path, merge_condition, 'race_id' )
